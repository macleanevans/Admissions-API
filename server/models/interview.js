...
Interview.create = function(req, res){
  client.query('INSERT INTO interviews (interviewer_id, decision, technical_grade, personal_grade, makerPrep, notes) VALUES ($1,$2,$3,$4,$5,$6)', [req.interviewer_id, req.decision, req.technical_grade, req.personal_grade, req.makerPrep, req.notes], function(err, response){
